...
class ConsumeConcurrencyTest {
    ...
    private lateinit var gifticonId: UUID
    ...
    fun setUp() {
        ...
        val user = User(name = "ConcurrencyUser", phoneNumber = "010-0000-0000", email = "concurrency@example.com")
        ...
        val gifticon = Gifticon(userId = userId, productId = product.id, code = "CONC-TEST-001")
        gifticonRepository.save(gifticon)
        gifticonId = gifticon.id
    }

    @Test
    fun `concurrent consume - only one succeeds`() {
        val threadCount = 2
